/***************************************************************************
                 co_i_facturasrec.qs  -  description
                             -------------------
...
function interna_validateForm():Boolean
{
	...
	var codSerie:String = this.child("fdbCodSerie").value();
	...
	if (codSerie &&	!util.sqlSelect("series", "codserie", "codserie = '" + codSerie + "'")) {
			MessageBox.critical
					(util.
						translate("scripts",
											"La Serie no existe en la tabla de Series de Facturación"),
						MessageBox.Ok, MessageBox.NoButton, MessageBox.NoButton);
			return false;
	}

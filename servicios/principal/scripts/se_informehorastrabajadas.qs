/***************************************************************************
                 se_informehorastrabajadas.qs  -  description
                             -------------------
    begin                : vie feb 20 2009
	...
	switch(fN){
		...
		case "codintervalo":{
			...
			if(cursor.valueBuffer("codintervalo")){
				...
				cursor.setValueBuffer("d_se__horastrabajadas_fecha",intervalo.desde);
				cursor.setValueBuffer("h_se__horastrabajadas_fecha",intervalo.hasta);
			}
			break;
		}
	}

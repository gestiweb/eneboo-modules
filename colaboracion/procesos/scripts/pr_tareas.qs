...
function interna_init()
{
	...
	this.child("gbxBarraBotones").close();
	var idDocumento:String = util.sqlSelect("gd_objetosdoc", "iddocumento", "tipoobjeto = 'pr_tareas' AND clave = '" + cursor.valueBuffer("idtarea") + "'");
	if (idDocumento || idDocumento != "") {
		...
		this.child("pbnVerDocumentacion").setDisabled(true);
	}
}

...
function interna_init()
{
	...
	this.child("fdbCodSubProyecto").setFilter("codproyecto = '" + cursor.valueBuffer("codproyecto") + "'");

	// Tareas
	if (sys.isLoadedModule("flcolaproc")) {
		var datosS:Array;
		datosS["tipoObjeto"] = "cl_incidencias";
...
{
	var util:FLUtil = new FLUtil();
	return util.nextCounter("codincidencia", this.cursor());
}
//// INTERNA /////////////////////////////////////////////////////
/////////////////////////////////////////////////////////////////

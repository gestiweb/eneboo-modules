/***************************************************************************
                 crm_masterestadostarjeta.qs  -  description
                             -------------------
...
{
	var util:FLUtil = new FLUtil();
	if (!util.sqlUpdate("crm_estadostarjeta", "valordefecto", "false", "valordefecto = true"))
		return false;

	if (!util.sqlUpdate("crm_estadostarjeta", "valordefecto", "true", "codestado = '" + codEstado + "'"))
		return false;
	return true;
}
//// OFICIAL /////////////////////////////////////////////////////

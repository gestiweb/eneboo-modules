/***************************************************************************
                 crm_masterestadoscontacto.qs  -  description
                             -------------------
    begin                : jue may 24 2007
...
{
	var util:FLUtil = new FLUtil();
	if (!util.sqlUpdate("crm_estadoscontacto", "valordefecto", "false", "valordefecto = true"))
		return false;

	if (!util.sqlUpdate("crm_estadoscontacto", "valordefecto", "true", "codestado = '" + codEstado + "'"))
		return false;
	return true;
}
//// OFICIAL /////////////////////////////////////////////////////

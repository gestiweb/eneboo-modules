/***************************************************************************
                 crm_masterestadoscampana.qs  -  description
                             -------------------
...
{
	var util:FLUtil = new FLUtil();
	if (!util.sqlUpdate("crm_estadoscampana", "valordefecto", "false", "valordefecto = true"))
		return false;

	if (!util.sqlUpdate("crm_estadoscampana", "valordefecto", "true", "codestado = '" + codEstado + "'"))
		return false;
	return true;
}
//// OFICIAL /////////////////////////////////////////////////////

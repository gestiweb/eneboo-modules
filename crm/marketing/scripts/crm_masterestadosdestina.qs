/***************************************************************************
                 crm_masterestadosdestina.qs  -  description
                             -------------------
...
{
	var util:FLUtil = new FLUtil();
	if (!util.sqlUpdate("crm_restadosdestina", "valordefecto", "false", "valordefecto = true"))
		return false;

	if (!util.sqlUpdate("crm_restadosdestina", "valordefecto", "true", "codestado = '" + codEstado + "'"))
		return false;
	return true;
}
//// OFICIAL /////////////////////////////////////////////////////

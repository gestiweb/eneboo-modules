/***************************************************************************
                 i_masterhorasoperarios.qs  -  description
                             -------------------
...
//MessageBox.warning("Normal: "+nombreInforme, MessageBox.No, MessageBox.Yes, MessageBox.NoButton);
		...
		if (nombreInforme == "i_horasoperarios")
			groupBy = "lineashorasope.codoperario, lineashorasope.apellidos, lineashorasope.nombre, centroscoste.descripcion, horasope.codcentro, horasope.fecha, empresa.nombre";
		else
			groupBy = "lineashorasope.codoperario, lineashorasope.apellidos, lineashorasope.nombre, empresa.nombre";

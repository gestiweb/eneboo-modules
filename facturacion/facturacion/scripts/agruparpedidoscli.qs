/***************************************************************************
                 agruparpedidoscli.qs  -  description
                             -------------------
...
//// INTERNA /////////////////////////////////////////////////////
/** \C
Este formulario agrupa distintos pedidos del mismo cliente un único albarán. Es posible especificar los criterios que deben cumplir los pedidos a incluir. De la lista de pedidos que cumplen los criterios de búsqueda se generará un albarán por cliente (ej. si los pedidos corresponden a dos clientes se generarán dos albaranes).
\end */
function interna_init()
{
		...
		tblPedidos.setColumnLabels("/", "Incluir/Código/Fecha/Total/Cliente/Nombre/idalbaran");
